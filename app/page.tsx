...
export default function Home() {
  ...
  return (
    <div>
      <Input placeholder="Folder ID or URL" value={folderInput} onChange={(e) => setFolderInput(e.target.value)} className='w-full max-w-xs' />
      <Button className='ml-2'  disabled={folderInput == "" || folderInput == null || folderInput.length < 1} onClick={handleGoClick}>Go</Button>
    </div>
  )
}
